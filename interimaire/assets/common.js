...
const MISSIONS = [
  { id:'m1', statut:'proposee', qualification:'FLEXI SOUS-CHEF', etablissement:'Hyatt Regency Paris Étoile', dateDebut:'2026-09-28', dateFin:'2026-09-28', horaireDebut:'09:00', horaireFin:'17:00', lieu:'203 rue de Vaugirard, 75015 Paris', taux:13.10, consignes:'Tenue noire fournie sur place. Se présenter à l’accueil du personnel 15 min avant le service.' },
  { id:'m2', statut:'proposee', qualification:'FLEXI HÔTE/HÔTESSE', etablissement:'Novotel Paris Vaugirard', dateDebut:'2026-10-03', dateFin:'2026-10-03', horaireDebut:'15:00', horaireFin:'23:00', lieu:'257 rue de Vaugirard, 75015 Paris', taux:12.50, consignes:'Accueil clientèle événementielle. Anglais courant requis.' },
  { id:'m3', statut:'validee', qualification:'CHEF DE RANG', etablissement:'Hyatt Regency Paris Étoile', dateDebut:'2026-10-04', dateFin:'2026-10-04', horaireDebut:'08:00', horaireFin:'17:00', lieu:'203 rue de Vaugirard, 75015 Paris', taux:12.31, consignes:'Service petit-déjeuner puis banquet midi. Pointeuse badge n°4.' },
  { id:'m4', statut:'validee', qualification:'FLEXI HOUSEKEEPING', etablissement:'Hyatt Regency Paris Madeleine', dateDebut:'2026-09-30', dateFin:'2026-09-30', horaireDebut:'07:00', horaireFin:'15:00', lieu:'24 boulevard Malesherbes, 75008 Paris', taux:11.88, consignes:'Chariot et matériel fournis. Passage obligatoire au local linge avant prise de poste.' },
  { id:'m5', statut:'validee', qualification:'FLEXI BANQUET', etablissement:'Hyatt Regency Paris Étoile', dateDebut:'2026-10-09', dateFin:'2026-10-09', horaireDebut:'18:00', horaireFin:'02:00', lieu:'203 rue de Vaugirard, 75015 Paris', taux:12.31, consignes:'Service soirée gala, 220 couverts.' },
  { id:'m6', statut:'validee', qualification:'FLEXI HOUSEKEEPING', etablissement:'Hyatt Regency Paris Madeleine', dateDebut:'2026-10-12', dateFin:'2026-10-12', horaireDebut:'07:00', horaireFin:'15:00', lieu:'24 boulevard Malesherbes, 75008 Paris', taux:11.88, consignes:'' },
  { id:'m7', statut:'validee', qualification:'FLEXI SOUS-CHEF', etablissement:'Novotel Paris Vaugirard', dateDebut:'2026-10-15', dateFin:'2026-10-15', horaireDebut:'09:00', horaireFin:'17:00', lieu:'257 rue de Vaugirard, 75015 Paris', taux:13.10, consignes:'' },
  { id:'m8', statut:'terminee', qualification:'FLEXI HOUSEKEEPING', etablissement:'Hyatt Regency Paris Madeleine', dateDebut:'2026-09-16', dateFin:'2026-09-16', horaireDebut:'07:00', horaireFin:'15:00', lieu:'24 boulevard Malesherbes, 75008 Paris', taux:11.88, consignes:'', releveValide:true, heuresValidees:'07:00–15:00', montant:95.04 },
  { id:'m9', statut:'terminee', qualification:'CHEF DE RANG', etablissement:'Hyatt Regency Paris Étoile', dateDebut:'2026-09-11', dateFin:'2026-09-11', horaireDebut:'08:00', horaireFin:'17:00', lieu:'203 rue de Vaugirard, 75015 Paris', taux:12.31, consignes:'', releveValide:true, heuresValidees:'08:00–17:00', montant:110.79 },
  { id:'m10', statut:'terminee', qualification:'FLEXI BANQUET', etablissement:'Hyatt Regency Paris Étoile', dateDebut:'2026-09-04', dateFin:'2026-09-04', horaireDebut:'18:00', horaireFin:'02:00', lieu:'203 rue de Vaugirard, 75015 Paris', taux:12.31, consignes:'', releveValide:true, heuresValidees:'18:00–01:30', montant:92.33 },
  { id:'m11', statut:'terminee', qualification:'FLEXI HÔTE/HÔTESSE', etablissement:'Novotel Paris Vaugirard', dateDebut:'2026-08-27', dateFin:'2026-08-27', horaireDebut:'15:00', horaireFin:'23:00', lieu:'257 rue de Vaugirard, 75015 Paris', taux:12.50, consignes:'', releveValide:true, heuresValidees:'15:00–23:00', montant:100.00 },
  { id:'m12', statut:'annulee', qualification:'FLEXI SOUS-CHEF', etablissement:'Novotel Paris Vaugirard', dateDebut:'2026-09-20', dateFin:'2026-09-20', horaireDebut:'09:00', horaireFin:'17:00', lieu:'257 rue de Vaugirard, 75015 Paris', taux:13.10, consignes:'', annulePar:'Client' }
];
